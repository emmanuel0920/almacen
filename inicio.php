...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Control de Almacén- Municipio de Jesús María</title>
	...
	<body class="no-skin">
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="inicio.php" class="navbar-brand">
						<small>
							<div class="nin">
								<p><i>&nbsp;<img src="img/logo_jm.png" width="30"></i>Control de almacén</p>
							 </div>
						</small>
					</a>
				</div>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive-min                    ace-save-state sidebar-fixed sidebar-scroll">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="javascript:cambiarcont('view/reportes/reportes.php');">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#body_content").html("<img src='img/exit.gif' class='img-responsive center-block' alt='Cargando...' />");
			    $('#body_content').load('view/productos/asignar.php');
				$("#body_content").fadeIn(10000);
			});
		</script>
	</body>
